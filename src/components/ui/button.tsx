  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:scale-105 shadow-travel border-0 font-semibold transition-bounce",
        ocean: "bg-gradient-ocean text-white hover:scale-105 shadow-travel border-0",
        sunset: "bg-gradient-sunset text-white hover:scale-105 shadow-travel border-0",
        adventure: "bg-adventure-green text-white hover:bg-adventure-green/90 shadow-card",
